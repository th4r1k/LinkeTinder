...
//    CandidateUncoupled(String name, String email, String country, String state, int doc, int zipCode, int age, List<String> qualification, int age1, List<String> qualification1, ICandidatesUncoupled candidates) {
//        super(name, email, country, state, doc, zipCode, age, qualification)
//        this.age = age1
//        this.qualification = qualification1
//        this.candidates = candidates
//    }

//    void create(CandidateUncoupled candidate){
